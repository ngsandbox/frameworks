...
The example422__MarketPrice__ErrorClient application is provided as an example of
...
example422__MarketPrice__ErrorClient implements the following high level steps:
...
+ Performs the following functionalities (this error scenarios are done on purpose
  ...
  - Invalid handle to submit GenericMsg
