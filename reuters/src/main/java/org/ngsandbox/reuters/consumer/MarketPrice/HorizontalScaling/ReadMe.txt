...
The example410__MarketPrice__HorizontalScaling application is provided as an example
...
example410__MarketPrice__HorizontalScaling showcases horizontal scaling capability
...
example410__MarketPrice__HorizontalScaling implements the following high level steps:
