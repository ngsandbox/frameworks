...
example130__MarketPrice__UserDisp is provided as an example of an OMM Consumer 
...
example130__MarketPrice__UserDisp illustrates a "user dispatch" mode in which all 
...
example130__MarketPrice__UserDisp implements the following high-level steps:
