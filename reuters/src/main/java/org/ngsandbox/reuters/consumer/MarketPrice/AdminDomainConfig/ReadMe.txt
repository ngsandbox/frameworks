...
The example420__MarketPrice__AdminDomainConfig application is provided as
...
example420__MarketPrice__AdminDomainConfig showcases customization of the default EMA
...
example420__MarketPrice__AdminDomainConfig implements the following high level steps:
