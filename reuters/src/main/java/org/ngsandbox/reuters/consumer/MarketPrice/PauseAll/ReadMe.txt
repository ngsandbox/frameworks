...
The example350__MarketPrice__PauseAll application is provided as an example of
...
example350__MarketPrice__PauseAll implements the following high level steps:
