...
The example301__MarketPrice__PriorityChange application is provided as an example
...
example301__MarketPrice__PriorityChange implements the following high level steps:
