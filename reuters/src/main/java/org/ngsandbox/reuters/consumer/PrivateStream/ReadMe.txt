...
The example220__MarketByPrice__PrivateStream application is provided as an example
...
and parsing of OMM MarketByPrice data from Reuters Data Feed Direct (RDF-D),
directly from an OMM Provider application, or from Thomson Reuters Advanced
Distribution Server.

example220__MarketByPrice__PrivateStream showcases opening and processing of
private stream MarketByPrice item. The item is requested as private by
setting privateStream( true ) on the ReqMsg.


Detailed Description
====================

example220__MarketByPrice__PrivateStream implements the following high level steps:
...
+ Implements OmmConsumerClient class in AppClient
  ...
  - provides own methods as needed, e.g. decode( FieldList )
	...
	- the decode( Map ) iterates through the received Map, extracts Summary
