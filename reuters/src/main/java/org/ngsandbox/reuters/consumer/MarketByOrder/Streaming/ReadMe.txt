...
example140__MarketByOrder__Streaming is an example of an OMM Consumer application
...
example140__MarketByOrder__Streaming illustrates how to open and process a
...
example140__MarketByOrder__Streaming implements the following high-level steps:
