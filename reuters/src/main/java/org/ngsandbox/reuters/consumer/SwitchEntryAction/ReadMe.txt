...
The example230__MarketByOrder__SwitchEntryAction application is provided as an
...
example230__MarketByOrder__SwitchEntryAction showcases application varying processing
...
example230__MarketByOrder__SwitchEntryAction implements the following high level steps:
