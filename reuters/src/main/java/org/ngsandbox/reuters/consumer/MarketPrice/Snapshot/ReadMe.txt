...
example102__MarketPrice__Snapshot is an example of an OMM Consumer application
...
example102__MarketPrice__Snapshot illustrates how to open a single snapshot OMM item.
...
example102__MarketPrice__Snapshot implements the following high-level steps:
