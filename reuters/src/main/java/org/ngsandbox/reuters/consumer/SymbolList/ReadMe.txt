...
The example270__SymbolList application is provided as an example of OMM Consumer
...
example270__SymbolList implements the following high level steps:

+ Implements OmmConsumerClient class in AppClient
  - overrides desired methods
  - provides own methods as needed, e.g. decode( FieldList, boolean )
    - the method decode( FieldList, boolean ) iterates through the received FieldList,
