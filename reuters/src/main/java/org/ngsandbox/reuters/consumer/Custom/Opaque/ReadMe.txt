...
The example250__Custom__Opaque application is provided as an example of OMM Consumer
...
example250__Custom__Opaque showcases opening and processing of a custom domain
...
example250__Custom__Opaque implements the following high level steps:
