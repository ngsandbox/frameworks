...
example110__MarketPrice__FileConfig is an OMM Consumer application example
...
example110__MarketPrice__FileConfig illustrates an implicit dependence of the 
...
example110__MarketPrice__FileConfig implements the following high-level steps:
