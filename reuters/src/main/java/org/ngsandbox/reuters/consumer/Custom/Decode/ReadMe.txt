...
The example290__Custom__Decode application is provided as an example of OMM Consumer
...
example290__Custom__Decode showcases decoding of items on custom OMM domain.
...
example290__Custom__Decode implements the following high level steps:
