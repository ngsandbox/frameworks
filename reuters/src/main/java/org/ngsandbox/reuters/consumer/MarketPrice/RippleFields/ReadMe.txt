...
The example240__MarketPrice__RippleFields application is provided as an example
...
and handling ripple fields of OMM MarketPrice data from Reuters Data Feed
...
example240__MarketPrice__RippleFields implements the following high level steps:
