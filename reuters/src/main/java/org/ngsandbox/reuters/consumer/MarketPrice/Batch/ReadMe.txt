...
The example370__MarketPrice__Batch application is provided as an example of OMM
...
example370__MarketPrice__Batch showcases usage of batch request feature of OMM
Consumer.

Detailed Description
====================

example370__MarketPrice__Batch implements the following high level steps:
