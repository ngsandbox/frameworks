...
The example310__MarketPrice__Rmtes application is provided as an example of OMM Consumer
...
example310__MarketPrice__Rmtes implements the following high level steps:
